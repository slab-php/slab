...
function getMimeTypeForExtension($ext) {
	...
	if (isset($slabMimeTypes[$ext])) {
		$mimeType = $slabMimeTypes[$ext];
...
// Data from http://www.webmaster-toolkit.com/mime-types.shtml
// as at 2012-03-11 and may not be up to date
$slabMimeTypes = array(
	'3dm' => 'x-world/x-3dmf',
	'3dmf' => 'x-world/x-3dmf',
	...
	'au' => 'audio/basic',
	'au' => 'audio/x-au',
	'avi' => array('video/avi', 'application/x-troff-msvideo', 'video/msvideo', 'video/x-msvideo'),
	'avs' => 'video/avs-video',
